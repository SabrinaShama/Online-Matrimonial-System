...
<head>
  ...
  <style>
	...
	#dot:hover, #dot1:hover, #dot2:hover, #dot4:hover, #op:hover{
	...
	.searchpro_page_form_profile p{
		font-family: Bradley Hand, cursive;
		font-size: 1em;
		color: #2e4045;
		text-align: left;
	}	
	.searchpro_page_form_profile h2{
          width: 70%;
		  background-color: #2e4045;
		  color: white;
		  font-family: Bradley Hand, cursive;
  ...
  <script>
	...
	$(document).on('click', '#dp1', function(){  
			...
			var id2 = '<?php echo $srow['id'] ;?>';
			var user = '<?php echo $_SESSION['username'] ;?>';
			var user2 = '<?php echo $srow['username'] ;?>';
			if(confirm("Are you interested to this person?"))  
			{  
                $.ajax({  
                    url:"interest.php",  
                    method:"POST",  
                    data:{id:id, id2:id2, user:user, user2:user2},  
                    dataType:"text",  
	...
	$(document).on('click', '#dp2', function(){  
			var user = '<?php echo $srow['username'] ;?>';
			if(confirm("Are you sure you want to report this account?"))  
			{  
                $.ajax({  
                    url:"report.php",  
                    method:"POST",  
...
<body>
  <div class="main_page_parallax">
	...
	class="matrimony_title_bar_navigator">
      <div class="row">
        ...
        <div class="col-md-offset-6"> 
			...
			<li>
				<button id="dot1" onclick = "window.history.back();">My Profile</button>
            </li>
			<li>
				<button id="dot2">Profile</button>
            </li>
			<li class="dropdown">				
				<button class="dropbtn" id="dot3">Interact   &#9660;</button>
				<div class="dropdown-content">
					<button id = "dp1">Interested</button>
					<button id = "dp2">Report</button>
				</div>
            <li>
	...
	<div class="searchpro_page_form_home" id="comm1">
	...
	<div class="searchpro_page_form_profile" id="comm2">
	...
	<div class="searchpro_page_form_gap"></div>
	<div class="searchpro_page_form_contact" id="comm3">
